...
# font_times_new_roman_global = {'family': 'Times New Roman', 'weight': 'normal', 'size': 12}
...
class PlotConfusionMatrix:
    ...
    def plot_confuse_matrix_results(self, fig_save_name):
        ...
        if self.show_type == 'all':
            ...
            #  cmap='YlGnBu', 'Blues'
            ax = sns.heatmap(self.cm, cmap=self.cmap, fmt='.1f', cbar=True, annot=True, square=True, annot_kws={'size': 14},
